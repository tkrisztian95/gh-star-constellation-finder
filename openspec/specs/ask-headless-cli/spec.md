# ask-headless-cli Specification

## Purpose
The `--ask "<question>"` flag and its headless JSON output contract, including the unpopulated-cache error path. Created by archiving change headless-ask.
